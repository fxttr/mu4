...
#define STACK_X 0x8 // Executable segment
#define STACK_W 0x2 // Writeable (non-executable segments)
#define STACK_R 0x2 // Readable (executable segments)
